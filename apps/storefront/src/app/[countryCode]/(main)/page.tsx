...
export default async function Home(props: {
  ...
  return <div className="bg-[#f9f9f9]"><SideBanner ads={ads} /><PromoCarousel ads={ads} /><CategoryStrip categories={categories} /><section className="content-container py-4"><TrustBadges ads={trustAds} /></section><ProductRail title="Flash Deals & Clearance" products={dealProducts} region={region} /><ProductRail title="Best-Selling Components" products={products.slice().reverse()} region={region} /><ProductRail title="New Arrivals" products={products.slice(2)} region={region} /><section className="content-container py-8"><TrustBadges ads={trustAds} compact /></section></div>
}
